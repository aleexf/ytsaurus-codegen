...
#include <yt/yt/library/query/row_validator/provider.h>
...
void GenerateAndValidateComplexLogicalType(TStringBuf ysonData, const TLogicalTypePtr& type)
{
    static auto validatorsProvider = NYT::NQueryClient::CreateRowValidatorProvider();
    TMemoryInput in(ysonData);
    NYson::TYsonPullParser parser(&in, NYson::EYsonType::Node);
    NYson::TYsonPullParserCursor cursor(&parser);
    TComplexTypeFieldDescriptor description(type);
    auto validator = validatorsProvider->Get(type);
    validator(&cursor, &description);
}
...
#define EXPECT_BAD_TYPE(logicalTypeExpr, ysonString) \
    do { \
        ...
        try { \
            GenerateAndValidateComplexLogicalType(ysonString, logicalType); \
...
TEST(TLogicalTypeValidatorBuilderTest, TestBasicTypes)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestSimpleOptionalTypes)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestOptionalNull)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestLogicalTypes)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestAnyType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestJsonType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestDecimalType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestOptionalCompositeType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestListType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestStructType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestTupleType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestVariantStructType)
{
    TestVariantImpl(ELogicalMetatype::VariantStruct);
}

TEST(TLogicalTypeValidatorBuilderTest, TestVariantTupleType)
{
    TestVariantImpl(ELogicalMetatype::VariantTuple);
}

TEST(TLogicalTypeValidatorBuilderTest, TestDictType)
{
...
TEST(TLogicalTypeValidatorBuilderTest, TestTaggedType)
{
